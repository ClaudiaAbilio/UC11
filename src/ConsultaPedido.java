...
public class ConsultaPedido extends javax.swing.JFrame {
    ...
    public ConsultaPedido() {
        ...
        initComponents();
        carregarPedidos();
        // Adicionar listener para atualizações de DetalhePedido
    ...
    private void carregarPedidos() {
        ...
        for (Pedido pedido : Global.pedidos) {
            ...
            // Add a row with the Pedido details
            if (cliente != null) {
                model.addRow(new Object[]{
                    pedido.getId(),
                    pedido.getDataVenda(),
                    cliente.getNome(),
                    pedido.getTotal() // Ensure this is the correct total
                });
            }
        }
    }
    ...
    private void carregarDetalhesPedido(int pedidoId) {
        ...
        for (DetalhePedido detalhe : Global.detalhepedidos) {
            if (detalhe.getVendaId() == pedidoId) {
                // Find the product name using the produtoId
                ...
                model.addRow(new Object[]{
                    ...
                    detalhe.getQuantidade() * detalhe.getPrecoUnitario() // Total for this item
                });
            }
        }
    }
    ...
    private String getNomeProdutoById(int produtoId) {
        ...
        return "Produto não encontrado"; // Retorno padrão se o produto não for encontrado
    }
    ...
    private void btnExcluirPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirPedidoActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            // Clear the detalhe table since the pedido is deleted
    ...
    private void deletePedido(int pedidoId) {
        // Remove pedido from Global.pedidos
        Global.pedidos.removeIf(pedido -> pedido.getId() == pedidoId);

        // Remove corresponding detalhes from Global.detalhepedido
